...
public class User implements UserDetails {
    ...
    public String userInfoWithoutPassword() {
        return String.format("Date: name = '%s %s', email = '%s', username = '%s', phone nr. = '%s', roles = '%s'",
                firstName, lastName, email, username, mobileNumber, roles.toString());
    }
    public String userInfoWithPassword() {
        return String.format("Date: name = '%s %s', email = '%s', username = '%s', password = '%s', phone nr. = '%s', roles = '%s'",
